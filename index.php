...
<body>
    ...
    <nav class="navbar py-2 navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">SPARKS BANK <img src="logos/logo3.jpg" alt="Bank" width="50" height="50"></a>
    ...
    <class class="welcome">
        <h2>
            <strong>Welcome to Sparks Bank!!!</strong> </h2>
    </class>
    ...
    <div id="carouselExampleCaptions" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="background/bg2.jpg" width="1000" height="375" class="d-block w-100" alt="...">

            </div>
            <div class="carousel-item">
                <img src="background/bg6.jpg" width="1000" height="375" class="d-block w-100" alt="...">
